...
export const SignupEmail = ({ confirmationUrl }: { siteName?: string; siteUrl?: string; recipient?: string; confirmationUrl: string }) => {
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:520px;background-color:#FFFFFF;border:1px solid #E4E2DF;border-radius:16px;overflow:hidden;">
        ...
        <tr>
          <td style="padding:28px;font-family:'Noto Sans Georgian',Arial,Helvetica,sans-serif;color:#1C1C1E;">
            <h1 style="margin:0 0 12px;font-size:20px;line-height:1.4;font-weight:bold;color:#1C1C1E;">კეთილი იყოს შენი მობრძანება!</h1>
            <p style="margin:0 0 22px;font-size:15px;line-height:1.7;color:#4A4A4A;">
              მადლობა, რომ SpeakBusy-ს შემოუერთდი. სწავლის დასაწყებად დაადასტურე შენი ელფოსტის მისამართი.
            </p>
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 22px;">
              <tr>
                <td align="center" style="background-color:#C9A84C;border-radius:999px;">
                  <a href="${confirmationUrl}" style="display:inline-block;padding:14px 30px;font-family:'Noto Sans Georgian',Arial,Helvetica,sans-serif;font-size:15px;font-weight:bold;color:#5C1A2E;text-decoration:none;">ელფოსტის დადასტურება</a>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:0;font-size:13px;line-height:1.6;color:#8A8A8A;">
              ბმული შეზღუდული დროით მოქმედებს. თუ ანგარიში შენ არ შეგიქმნია, უბრალოდ არ მიაქციო ამ წერილს ყურადღება.
            </p>
          </td>
        </tr>
        <tr>
  ...
  return (
    <Html lang="ka" dir="ltr">
      <Head />
      <Preview>დაადასტურე შენი ელფოსტა — SpeakBusy</Preview>
