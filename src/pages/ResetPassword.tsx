    ...
    <Layout showLogout={false}>
      ...
      <div className="max-w-sm mx-auto py-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold ka text-[#5C1A2E] mt-4 tracking-tight">
            ახალი პაროლი
          </h1>
        ...
        {invalidLink && !ready ? (
          <div className="p-6 rounded-2xl bg-[#F5F4F2] border border-[#E4E2DF] text-center">
            <p className="text-sm text-[#5C1A2E] ka leading-relaxed">
              ბმული არასწორია ან ვადა გაუვიდა. გთხოვთ, მოითხოვოთ ახალი ბმული.
            </p>
            <Link
              to="/forgot-password"
              className="inline-block mt-4 text-sm font-semibold text-[#5C1A2E] underline ka"
            >
