    ...
    <Layout showLogout={false}>
      ...
      <div className="max-w-sm mx-auto py-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold ka text-wine mt-4 tracking-tight">
            ახალი პაროლი
          </h1>
        ...
        {invalidLink && !ready ? (
          <div className="p-6 rounded-2xl bg-cream border border-line text-center">
            <p className="text-sm text-wine ka leading-relaxed">
              ბმული არასწორია ან ვადა გაუვიდა. გთხოვთ, მოითხოვოთ ახალი ბმული.
            </p>
            <Link
              to="/forgot-password"
              className="inline-block mt-4 text-sm font-semibold text-wine underline ka"
            >
          ...
          >
            ...
            <div>
              <Label htmlFor="confirm" className="ka text-xs font-semibold tracking-wide uppercase text-ink-muted">
                გაიმეორე პაროლი
              </Label>
              <Input
                id="confirm"
