    ...
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <button
          type="button"
          aria-label="Dev menu"
          className="fixed z-[100] bottom-4 right-4 h-11 px-3 inline-flex items-center gap-1.5 rounded-full bg-[#1C1C1E] text-white text-[11px] font-mono uppercase tracking-wider shadow-lg border border-amber-500/60 hover:bg-amber-500 hover:text-black transition-colors"
        >
          <Wrench className="w-3.5 h-3.5" />
          Dev
        </button>
      </SheetTrigger>
      <SheetContent side="right" className="w-[320px] sm:w-[360px] overflow-y-auto p-0 bg-[#1C1C1E] text-white border-l border-amber-500/40">
